...
Map m = new Map();
   ...
   static int kill_c=0;
int man;
    public void Attack(JButton button, Color color,Ham_Marz ham_marz,JButton att1,JButton att2,JButton att3,
                       JButton def1,JButton def2,JLabel attacker,JLabel defender,JLabel amaro,JLabel amarp,
        ...
        else if (attack2 == false && !button.getBackground().equals(color) ) {
            att[0] = button;
